            ...
            <div id='green-path' className='verticalPath'>
              <div className="ludoBox" id='r11'>
                 {tokens
                  ...
                  .map((t) => (
                    <img key={t.id} src="coinTomato.svg" onClick={() => diceValue && moveToken(t.id, diceValue)} className="token piece red-piece" />
                ))}
              </div>
            ...
            <div id='yellow-Board' ref={yellowBoardRef} className='board'>
              <div>
               {tokens.filter(t => t.player === 'yellow').map(t => (
                  <span key={t.id}><img src="coinTomato.svg" alt="" /></span>
                ))}
              </div>
            </div>
